...
class EMA:
    """
    exponential moving average - used for creating a EMA of the model paramters - used for inference of the model
    this often yeilds better performance of the model as it smothes over the noise of paramter updates
    inspired by:
